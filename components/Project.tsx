  ...
  return (
    ...
    >
      <div className="relative img-div rounded-2xl bg-gray-200 min-h-[300px] w-full mt-14 overflow-hidden group cursor-pointer">
        ...
        <div className="absolute inset-0 flex justify-center items-center gap-2 md:gap-3 opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 z-30 flex-wrap">
          <Link
            href={githubLink}
            target="_blank"
            rel="noopener noreferrer"
            className="px-3 md:px-5 py-2 bg-white text-black rounded-full shadow-lg text-sm hover:bg-gray-200 flex items-center gap-2"
          >
            <Github size={17} />
            GitHub
          </Link>
